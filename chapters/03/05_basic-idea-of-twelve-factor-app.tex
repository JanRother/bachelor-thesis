...
\begin{longtable}{  |   >{\raggedleft\factornumber}p{0.025\textwidth}   % Number (centered)
    ...
    %   (V) Build, Release, Run
        & Build, Release, Run
        & \q{Strictly separate build, release, and run stages.} \cite{101:The-Twelve-Factor-App}
    ...
    %   (VI) Processes
        & Processes
        & \q{Execute the app as one or more stateless processes.} \cite{101:The-Twelve-Factor-App}
    ...
    %   (VII) Port Binding
        & Port Binding
        & \q{Export services via port binding.} \cite{101:The-Twelve-Factor-App}
    ...
    %   (VIII) Concurrency
        & Concurrency
        & \q{Scale out via the process model.} \cite{101:The-Twelve-Factor-App}
    ...
    %   (IX) Disposability
        & Disposability
        & \q{Maximize robustness with fast startup and graceful shutdown.} \cite{101:The-Twelve-Factor-App}
    ...
    %   (X) Dev / Prod Parity
        & Dev / Prod Parity
        & \q{Keep development, staging, and production as similar as possible.} \cite{101:The-Twelve-Factor-App}
    ...
    %   (XI) Logs
        & Logs
        & \q{Treat logs as event streams.} \cite{101:The-Twelve-Factor-App}
    ...
    %   (XII) Admin Processes
        & Admin Processes
        & \q{Run admin or management tasks as one-off processes.} \cite{101:The-Twelve-Factor-App}
