...
\newcommand{\documentCategory}{Bachelorarbeit}
\newcommand{\course}{}
\newcommand{\courseAbbreviation}{}
\newcommand{\semester}{}
\newcommand{\projectDescription}
   {Toolchain-as-Code Strategie zum Überwinden des\\
    Development-Deployment-Gaps im\\
    Application Management eines großen Automobilherstellers}
\newcommand{\projectShortDescription}{Von der IDE zum Service}
...
\newcommand{\documentDayOfWeek}{Dienstag}
\newcommand{\documentDay}{10}
\newcommand{\documentMonth}{12}
\newcommand{\documentMonthOfYear}{Dezember}
\newcommand{\documentYear}{2024}
...
\newcommand{\firstAuthor}{\studentAName}