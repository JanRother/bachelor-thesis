...
\newglossaryentry{github-actions}{
    name={GitHub Actions},
    description={ist eine cloud-basierte Plattform für \acrfull{ci} und \acrfull{cd}, die das automatisieren von \Gls{build}, Test und Deployment Pipelines ermöglicht, wobei individuelle Ereignisse als Auslöser für einen so genannten Workflow konfigurierbar sind \cite{302:Understanding-GitHub-Actions}}
}
